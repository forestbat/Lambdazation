...
public final class ContainerCalibrator extends Container {
	public static final Identifier GUI_ID = new Identifier("lambdazation:calibrator");
	...
	public ContainerCalibrator(Lambdazation lambdazation, PlayerInventory playerInventory) {
	...
	public final class InventoryCalibrator implements IInventory {
		...
		public TextComponent getName() {
			return new TextComponent("Calibrator");
		}
