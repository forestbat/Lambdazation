...
import org.lambdazation.common.core.LambdazationBlockEntityTypes;
...
public final class Lambdazation {
	...
	public final LambdazationBlockEntityTypes lambdazationBlockEntityTypes;
	...
	public Lambdazation() {
		...
		lambdazationBlockEntityTypes = new LambdazationBlockEntityTypes(this);
		...
		FMLJavaModLoadingContext.get().getModEventBus().addGenericListener(BlockEntityType.class, lambdazationBlockEntityTypes::registerBlockEntityTypes);
		FMLJavaModLoadingContext.get().getModEventBus().addGenericListener(BlockEntityType.class, EventPriority.LOWEST, lambdazationBlockEntityTypes::finalizeBlockEntityTypes);
